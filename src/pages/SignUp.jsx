      ...
      <div className="lp-wrapper">
        ...
        <div className="lp-content">
          <div className="lp-card">
            ...
            <h1 className="lp-title">Create  new account</h1>
            ...
            <button className="lp-btn-login">SIGN UP</button>
          ...
          <p className="lp-footer-text">
            Already have an account? <span style={{color: 'white', fontWeight: '600', cursor: 'pointer'}}>Login</span>
          </p>
        </div>
